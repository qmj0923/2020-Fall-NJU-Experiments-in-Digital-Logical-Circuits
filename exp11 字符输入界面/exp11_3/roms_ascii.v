module roms_ascii(kbd_type, addr, dout_vec);
   ...
   initial begin
      dout_vec = 8'bz;
      $readmemh("D:/source/quartus/exp11_3/scancode.txt", normcode, 0, 255);
      $readmemh("D:/source/quartus/exp11_3/capcode.txt", capcode, 0, 255);
      $readmemh("D:/source/quartus/exp11_3/shiftcode.txt", shiftcode, 0, 255);
      $readmemh("D:/source/quartus/exp11_3/capshiftcode.txt", capshiftcode, 0, 255);
   end
